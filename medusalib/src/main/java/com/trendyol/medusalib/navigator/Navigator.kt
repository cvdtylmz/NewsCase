...
interface Navigator {
     ...
     * all fragments which has the same group name.
     */
    fun start(fragment: Fragment, fragmentGroupName: String, transitionAnimation: TransitionAnimationType?, customAnimations: Pair<Int, Int>?)
     ...
     * and show newly added fragment to the user.
     * @param fragment new fragment
     * @param animation will be used start and remove fragment transition animation
     * all fragments which has the same group name.
     */
    fun startWithAnimation(fragment: Fragment, customAnimations: Pair<Int, Int>)
