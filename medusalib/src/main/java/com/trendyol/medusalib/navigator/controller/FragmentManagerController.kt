...
class FragmentManagerController(private val fragmentManager: FragmentManager,
    ...
    private var currentCustomAnimation: Pair<Int,Int>? = null
    ...
    fun removeFragment(fragmentTag: String) {
        ...
        currentCustomAnimation?.second?.let {
            setCustomAnimations(R.anim.empty_animation, it)
        } ?: kotlin.run {
    ...
    fun disableAndStartFragment(disableFragmentTag: String, vararg fragmentDataArgs: FragmentData) {
        ...
        for (fragmentData in fragmentDataArgs) {
            ...
            currentCustomAnimation = fragmentData.customAnimations
            if (fragmentData.customAnimations != null) {
                setCustomAnimations(fragmentData.customAnimations.first, R.anim.empty_animation)
            } else {
                when (currentTransitionAnimationType) {
